        ...
        with ui.element('div').classes('form-grid'):
            ...
            with ui.element('div').classes('form-group'):
                with ui.row().classes('w-full gap-2'):
                    ...
                    ).classes('submit-btn bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-medium flex-grow')
                    
                    ui.button(
                        '查看历史记录',
                        on_click=lambda: ui.navigate.to('/qimen_records')
                    ).classes('submit-btn bg-purple-500 hover:bg-purple-600 text-white rounded-lg font-medium')
