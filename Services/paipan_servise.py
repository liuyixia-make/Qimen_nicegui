...
class 奇门遁甲:
    ...
    def 排天盘干(self):
        ...
        # 处理五宫的天盘干（中宫）
        if "五宫" in self.奇门遁甲数据 and "五宫" in 地盘干分布:
            天盘干分布["五宫"] = 地盘干分布["五宫"]
